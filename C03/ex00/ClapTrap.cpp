...
{
	if (_hit_points <= 0)
		std::cout << "ClapTrap " << get_Name() << " is dead, thus unable to attack"<< std::endl;
	else if (_energy_points <= 0)
		std::cout << "ClapTrap " << get_Name() << " has no energy, thus unable to attack"<< std::endl;
	else
	{
	std::cout 
		<< "ClapTrap "
...
{
	if (_hit_points <= 0)
		std::cout << "ClapTrap " << get_Name() << " is already dead, thus cannot endure more pain"<< std::endl;
	else
	{
		std::cout 
			<< "ClapTrap "
...
{
	if (_hit_points <= 0)
		std::cout << "ClapTrap " << get_Name() << " is already dead, thus cannot be repaired" << std::endl;
	else if (_energy_points <= 0)
		std::cout << "ClapTrap " << get_Name() << "has no energy, thus unable to be repaired" << std::endl;
	else
	{
	std::cout 
		<< "ClapTrap "
